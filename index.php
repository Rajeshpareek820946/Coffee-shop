   ...
   <body>
         ...
         <div class="container">
            ...
            <div class="">
               <div class="gallery_section_2">
                  <div class="row">
                     <?php 
                     $selImage="SELECT * FROM `blocks` WHERE status=1 And id<=8";
                     $imagerun=$conn->query($selImage);
                     while($row=mysqli_fetch_assoc($imagerun)){
                     ?>
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="admin/images/<?=$row['banner_image']?>" alt="Avatar" class="image" >
                           <div class="overlay">
      ...
      <div class="services_section layout_padding">
         <div class="container">
            ...
            <class="services_section_2">
               <div class="row">
                  <?php
                    $selIcon="SELECT * FROM `blocks` WHERE status=1 And id>8";
                    $imagerun=$conn->query($selIcon);
                    while($row=mysqli_fetch_assoc($imagerun)){
                    ?>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main active">
                        <div class="house_icon">
                           <img src="admin/images/<?=$row['banner_image']?>" class="image_1">
                           <!-- <img src="images/icon1.png" class="image_2"> -->
                        </div>
                        <h3 class="decorate_text"><?=$row['title']?></h3>
                        <p class="tation_text"><?=$row['description']?> </p>
